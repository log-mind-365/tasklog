...
final getTodosUseCaseProvider = AutoDisposeProvider<GetTodosUseCase>.internal(
  getTodosUseCase,
...
final toggleTodoDoneUseCaseProvider =
    AutoDisposeProvider<ToggleTodoDoneUseCase>.internal(
      toggleTodoDoneUseCase,
      name: r'toggleTodoDoneUseCaseProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$toggleTodoDoneUseCaseHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final searchTodosUseCaseProvider =
    AutoDisposeProvider<SearchTodosUseCase>.internal(
      searchTodosUseCase,
